    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (prompt.length > 1) {
                ...
                3. If anyone asks about your origin or similar question respond with I am cavilOn 
                ...
                5. If anyone asks who is your creator or who made you or similar question respond with Mayank and tell them that 
                    ...
                    <div className="w-full">
                        {loading ? (
                            ...
                            <>
                                ...
                                {!loading && (
                                    <button className="absolute duration-200 hover:bg-transparent hover:border-2 hover:border-purple-700 cursor-pointer right-3 p-2 top-4 bg-purple-600 rounded-full"  aria-label="Send message">
                                        <SendHorizontal />
                                    </button>
                                )}
                            </>
